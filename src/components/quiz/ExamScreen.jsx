        ...
        <aside className="col-span-3 p-6 pt-20 bg-card/50 backdrop-blur-sm border-r border-border overflow-y-auto">
          <div className="sticky top-20 space-y-6">
              ...
              {questions.map((q, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      flex flex-col items-center justify-center gap-0.5 w-full aspect-square rounded-lg text-sm font-semibold transition-colors duration-150
                       ${isCurrent ? 'ring-2 ring-warning ring-offset-2 ring-offset-background' : ''}
                       ${isAnswered ? 'bg-warning/25 text-foreground hover:bg-warning/35' : ''}
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              <span className="w-3 h-3 rounded bg-warning/25 inline-block" />
