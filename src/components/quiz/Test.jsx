...
const Test = ({data}) => {
  ...
  const [questions, setQuestions] = useState(preguntasAleatorias(npreguntas, data, preguntaAleatoria))  // Inicializamos con preguntas aleatorias
        ...
        <Card className='bg-white container min-h-screen h-1/5 gap-1  rounded-lg bg-opacity-60 backdrop-blur-sm  shadow-lg '>
          <CardContent className='p-1 md:p-4'>
            <AnimatePresence mode="wait">
              ...
              >
                {result ? null : (
                  <>
                    <h2 className='text-base md:text-xl font-bold pb-2'>{index + 1}. {question.question}</h2>
                ...
                {result && (
                  <>
                    <div className="flex flex-col">
                      < h2 className="text-xl">¡Has hecho {score} de {npreguntas} respuestas correctas!</h2>
                      < h2 className="text-xl pb-4">Tiempo Transcurrido:  {temporizadorRef.current?.getTime()}</h2>
                      
                      <Button className="flex flex-row justify-center items-center rounded-lg bg-sky-400 px-5 py-3 text-base mb-3 font-bold transition duration-200 hover:bg-sky-300 active:bg-sky-500" onClick={reset}>
                        Empezar de nuevo
                        <ArrowBigRightDash />
                      </Button>
                      {mal !== 0 && <Button className="flex flex-row justify-center items-center rounded-lg bg-indigo-400 px-5 py-3 text-base mb-3 font-bold transition duration-200 hover:bg-rose-300 active:bg-rose-500" onClick={resetErrores}>
          ...
          {!result &&
            <CardFooter className="flex flex-col">
              ...
              <Button className="w-full md:w-70 rounded-xl bg-sky-500 px-5 py-3 text-base mb-3 font-bold text-white transition duration-200 hover:bg-sky-400 active:bg-green-100" onClick={next}>
                <ArrowBigRightDash />
                Siguiente
              </Button>
      ...
      <div className='bg-emerald-300 w-full bg-opacity-30 pl-8 pr-4 md:w-1/6'>
        <div className="flex justify-between md:flex-col md:pt-20">
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-row drop-shadow-xl">
              <img src="/icons8-error-48.png" 
                  alt="icono mal" 
                  className={`transition-opacity duration-200 ${isVisibleMal ? 'opacity-100' : 'opacity-0'}`}
              />
              ...
              <div className='flex flex-col'>
                ...
                <div className='mt-2 flex flex-row items-center w-full justify-between text-sm font-medium text-gray-900 '>
                  <div className="flex items-center  space-x-2">
                    <Label htmlFor="preguntas-random">Preguntas Aleatorias</Label>
                    <Switch
                      id="preguntas-random"
          ...
          <div className='text-center w-56'>
            ...
            <div className='mx-auto my-4 w-48'>
              ...
              <div className="flex justify-center">
                <img width={50} src='/icons8-discord.png' alt='discord-icono'></img>
              </div>
              <p className='text-sm text-gray-500'>para ver posibles respuestas!</p>
